...
$basethemevar_ftrcta_headline = ( isset($fields['basethemevar_page_cta_headline']) ) ? $fields['basethemevar_page_cta_headline'] : ( isset($fields['basethemevar_to_cta_headline']) ) ? $option_fields['basethemevar_to_cta_headline'] : null;
